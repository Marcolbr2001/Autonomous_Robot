        ...
        if (sharedMemory && sharedMemory->valid()) {
            ...
            auto onDistance = [&distancesMutex, &front, &rear, &left, &right](cluon::data::Envelope &&env) {
                ...
                switch (senderStamp) {
                    ...
                    case 1: left = dr.distance(); break; //top left
                    case 3: rear = dr.distance(); break; // top rear
                    case 5: right = dr.distance(); break; // top right
                    //case 4: //bottom right
                    //case 5: // top right
                }
            };
            ...
            while (od4.isRunning()) {
                ...
                targetPosition = cv::Point2f(-1, -1); // Reset ad ogni ciclo
                ...
                switch (state) {
                    ...
                    case RobotState::TARGET_DETECTED: {
                        ...
                        if (targetPosition.x < 0 || targetPosition.y < 0) {
                            std::cout << "[INFO] Target lost. Back to exploring." << std::endl;
